        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyPrice_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    DailyPrice_Currency = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    RentedDate = table.Column<DateTime>(type: "date", nullable: false),
                    ...
                    Payment_Currency = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreditCard_CardNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreditCard_CardHolderName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreditCard_ExpirationDate = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreditCard_Cvv = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_City = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_Country = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_Street = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_ZipCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Address_OpenAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
